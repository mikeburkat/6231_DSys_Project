 ...
 */
public abstract class BehaviourPOA extends org.omg.PortableServer.Servant
        implements BehaviourOperations, org.omg.CORBA.portable.InvokeHandler
{
    public Behaviour _this()
    {
        return BehaviourHelper.narrow(_this_object());
    }

    public Behaviour _this(org.omg.CORBA.ORB orb)
    {
        return BehaviourHelper.narrow(_this_object(orb));
    }
